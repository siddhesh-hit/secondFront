    ...
    <div className="contactpage">
      <Col lg={12}>
        <div className="contactcontent">
          <h1>
            आमच्याशी संपर्क साधा<div className="hrline"></div>
          </h1>
        </div>
      </Col>
          ...
          <Col lg={3}>
            <div className="dbox w-100 text-center">
              ...
              <div className="text">
                <span>पत्ता:</span>
                <p>
                  महाराष्ट्र विधानमंडळ, विधान भवन , बॅकबे रेक्लमेशन , विधान भवन
                  मार्ग , मुंबई - ४०० ०३२.
                </p>
              </div>
            </div>
