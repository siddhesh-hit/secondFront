...
const Homepage1 = () => {
  return (
    <div>
      <section className="homepageback new1">
        <h1>
                ...
                <Link to="/">
                  <Row className="boxes">
                    ...
                    <Col lg={9}>
                      ...
                      <Link to="/Aboutus">विधान परिषद | </Link>
                      <Link to="/DebateDetails"> विधान सभा</Link>
                    </Col>
                  </Row>
                </Link>
              </Col>
                ...
                <Link to="/Debate">
                  <Row className="boxes">
                    ...
                    <Col lg={9}>
                      ...
                      <Link to="/Debate">सभागृह | </Link>
                      <Link to="/Debate">अधिवेशन | </Link>
                      <Link to="/Debate">वर्ष</Link>
                    </Col>
                  </Row>
                </Link>
              </Col>
              ...
              <Col lg={4}>
                <a href="#">
                  <Row className="boxes">
                    ...
                    <Col lg={9}>
                      <h6>निवडणूक निकाल</h6>
                      <Link to="/">विधान परिषद | </Link>
                      <Link to="/">विधान सभा </Link>
                    </Col>
                  </Row>
                </a>
              </Col>
                ...
                <Link href="#">
                  <Row className="boxes">
                    ...
                    <Col lg={9}>
                      <h6>मीडिया</h6>
                      <Link to="/">ऑडिओ | </Link>
                      <Link to="/">व्हिडिओ | </Link>
                      <Link to="/">वृत्तपत्र</Link>
                    </Col>
                  </Row>
                </Link>
              </Col>
      ...
      <section className="resourcesss new11">
        <Container>
          <h2>
            आतापर्यंत एमएलएस ग्रंथालयातील संसाधने, दस्तऐवज डिजीटलाइज्ड झाली आहे
            ते एक्सप्लोरे करा
          </h2>
          <Row>
            <Col lg={3}>
